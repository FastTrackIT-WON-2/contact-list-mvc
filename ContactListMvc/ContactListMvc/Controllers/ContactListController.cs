...
namespace ContactListMvc.Controllers
{
    public class ContactListController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ContactType,Name,DateOfBirth,Address,Phone,Email")] ContactListEntry contactListEntry)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ContactType,Name,DateOfBirth,Address,Phone,Email")] ContactListEntry contactListEntry)
        {
